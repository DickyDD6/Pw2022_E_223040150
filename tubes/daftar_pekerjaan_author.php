...
<head>
  <title>Halaman Author - Job Portal</title>
...
<body>
  <header>
    <h1>Job Portal - Halaman Author</h1>
  </header>
  <nav>
    <ul>
      <li><a href="author.php">Dashboard</a></li>
      <li><a href="daftar_pekerjaan_author.php">Manajemen Lowongan</a></li>
      <li><a href="index.php">Kembali </a></li>
    </ul>
  </nav>

  <a href="tambah_pekerjaan_author.php">tambah pekerjaan</a>
